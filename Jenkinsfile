pipeline {
    ...
    parameters {
        extendedChoice description: 'Select an Artifact.', multiSelectDelimiter: ',', name: 'ARTIFACT', propertyFile: './artifact_list', propertyKey: '', quoteValue: false, saveJSONParameterToFile: false, type: 'PT_SINGLE_SELECT', visibleItemCount: 5
